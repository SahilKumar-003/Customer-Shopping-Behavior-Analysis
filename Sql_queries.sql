...
-- Q1. What is total reveue generated by male and female customers ?
select gender, sum(purchase_amount_usd) as revenue
from customer
group by gender;

-- Q2. Which customer used a discount but still spent more than the average purhase amount ?
...
-- Q6. Which 5 products have the highest percentage of purchases with disccounts applied ?
